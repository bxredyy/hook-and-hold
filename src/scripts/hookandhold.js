...
const projects = [
  { client: 'Hook & Hold',         cat: 'Available',                 subj: 'Current Site on Auction',           prev: 'A premium catering platform template: seamless menu browsing, real-time booking, event inquiry management, and customer testimonials. Launch-ready, fully customizable.',                                                                                                                                  tag: 'auction', video: '/cateringdemo.mp4' },
  { client: 'Funeral Parlour',     cat: 'Funeral · Digital memorial',subj: 'Premium Digital Funeral Experience',prev: 'A premium digital memorial: livestream access, tribute walls, family galleries, digital order of service, guestbook, QR-coded access and remote participation. Helping families stay connected, supported and remembered — from anywhere in the world.', tag: 'concept', video: '/funeralparlour.mp4' },
